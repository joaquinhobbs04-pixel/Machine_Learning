...
try:
    ...
    if not os.path.exists(splitted_4d_output_dir):
        os.makedirs(splitted_4d_output_dir)
...
try:
    ...
    network_training_output_dir = "E:\\nnU-Net_v2\\nnUnet_results"
    if not os.path.exists(network_training_output_dir):
        os.makedirs(network_training_output_dir)
except KeyError:
